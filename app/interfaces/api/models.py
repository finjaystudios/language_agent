...
from app.application.models import ChatResult as ApplicationChatResult
from app.domain.intent_result import IntentResult
from app.domain.jobs import LLMCallJob, QueueStatusSnapshot
from app.domain.mode_responses import (
    DefinitionResponse,
    LearningResponse,
    TranslationResponse,
)
...
def chat_response_from_result(result: ApplicationChatResult) -> ChatResponse:
    return ChatResponse(
        mode=ApiMode(result.mode),
